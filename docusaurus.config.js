...
const config = {
  title: 'Papi Mock Server Documentation',
  ...
  url: 'https://conradparkzes.github.io',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/mockserver-docs/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'conradparkzes', // Usually your GitHub org/user name.
  projectName: 'mockserver-docs', // Usually your repo name.
